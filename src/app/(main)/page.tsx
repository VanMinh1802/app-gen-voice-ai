        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex-1 flex flex-col overflow-hidden lg:ml-64">
            ...
            <button
              ...
              className="fixed top-20 left-4 z-30 lg:hidden w-12 h-12 rounded-2xl bg-card/90 backdrop-blur-sm flex items-center justify-center text-foreground shadow-lg hover:bg-card transition-all hover:scale-105 active:scale-95 border border-border"
              aria-label="Mở menu"
            >
            ...
            {/* Main content */}
            <main className="flex-1 flex flex-col bg-background overflow-y-auto custom-scrollbar pb-28 sm:pb-24">
