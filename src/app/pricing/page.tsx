...
function PlanCard({
  ...
  const showFreeCurrentBadge =
    plan.code === "FREE" && !isProPlanCode(activePlanCode);
  return (
    <div
      className={cn(
      ...
      <section className="py-16 sm:py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Tất cả các gói đều bao gồm quyền truy cập TTS tiên tiến. Nâng cấp để
            mở khóa thêm tính năng.
          </p>
        </div>
      </section>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Thanh toán qua Genation Store. Bạn có thể dùng MoMo, ZaloPay
                hoặc thẻ ngân hàng.
              </p>
            </div>
            <div>
              ...
              <p className="text-muted-foreground">
                Có. Bạn có thể hủy bất kỳ lúc nào từ tài khoản Genation.
              </p>
            </div>
          </div>
        </div>
